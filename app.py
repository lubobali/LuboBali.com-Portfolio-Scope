...
# Accepts click evendef start_scheduler():
    ...
    try:
        ...
        # TESTING: Run at 01:35 UTC (5 minutes from now) for immediate test
        scheduler.add_job(
            run_daily_aggregation,
            CronTrigger(hour=1, minute=35, timezone='UTC'),
        ...
        # Start the scheduler
        scheduler.start()
        print(f"📅 Scheduler configured to run daily at 01:35 UTC (TESTING - 5 min from now)")
